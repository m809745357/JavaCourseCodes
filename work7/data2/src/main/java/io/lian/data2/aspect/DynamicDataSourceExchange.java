package io.lian.data2.aspect;

import io.lian.data2.aop.WatchDog;
...
public class DynamicDataSourceExchange {
    ...
    @Pointcut("@annotation(io.lian.data2.aop.WatchDog)")
    ...
    public Object beforeMethod(ProceedingJoinPoint pjp) throws Throwable {
        ...
        if (aClass.isAnnotationPresent(WatchDog.class)) {
            ...
            instance.setDatabaseShardingValue(watchDog.value());
        }
